...
import com.limurse.svgloader.BuildConfig;
import com.limurse.svgloader.PreserveAspectRatio;
import com.limurse.svgloader.SVGExternalFileResolver;
import com.limurse.svgloader.utils.SVGBase.Box;
import com.limurse.svgloader.utils.SVGBase.Circle;
import com.limurse.svgloader.utils.SVGBase.ClipPath;
import com.limurse.svgloader.utils.SVGBase.Colour;
import com.limurse.svgloader.utils.SVGBase.CurrentColor;
import com.limurse.svgloader.utils.SVGBase.Ellipse;
import com.limurse.svgloader.utils.SVGBase.GradientElement;
import com.limurse.svgloader.utils.SVGBase.GradientSpread;
import com.limurse.svgloader.utils.SVGBase.GraphicsElement;
import com.limurse.svgloader.utils.SVGBase.Group;
import com.limurse.svgloader.utils.SVGBase.Image;
import com.limurse.svgloader.utils.SVGBase.Length;
import com.limurse.svgloader.utils.SVGBase.Line;
import com.limurse.svgloader.utils.SVGBase.Marker;
import com.limurse.svgloader.utils.SVGBase.Mask;
import com.limurse.svgloader.utils.SVGBase.NotDirectlyRendered;
import com.limurse.svgloader.utils.SVGBase.PaintReference;
import com.limurse.svgloader.utils.SVGBase.PathDefinition;
import com.limurse.svgloader.utils.SVGBase.PathInterface;
import com.limurse.svgloader.utils.SVGBase.Pattern;
import com.limurse.svgloader.utils.SVGBase.PolyLine;
import com.limurse.svgloader.utils.SVGBase.Polygon;
import com.limurse.svgloader.utils.SVGBase.Rect;
import com.limurse.svgloader.utils.SVGBase.SolidColor;
import com.limurse.svgloader.utils.SVGBase.Stop;
import com.limurse.svgloader.utils.SVGBase.Svg;
import com.limurse.svgloader.utils.SVGBase.SvgConditional;
import com.limurse.svgloader.utils.SVGBase.SvgContainer;
import com.limurse.svgloader.utils.SVGBase.SvgElement;
import com.limurse.svgloader.utils.SVGBase.SvgElementBase;
import com.limurse.svgloader.utils.SVGBase.SvgLinearGradient;
import com.limurse.svgloader.utils.SVGBase.SvgObject;
import com.limurse.svgloader.utils.SVGBase.SvgPaint;
import com.limurse.svgloader.utils.SVGBase.SvgRadialGradient;
import com.limurse.svgloader.utils.SVGBase.Switch;
import com.limurse.svgloader.utils.SVGBase.Symbol;
import com.limurse.svgloader.utils.SVGBase.TRef;
import com.limurse.svgloader.utils.SVGBase.TSpan;
import com.limurse.svgloader.utils.SVGBase.Text;
import com.limurse.svgloader.utils.SVGBase.TextContainer;
import com.limurse.svgloader.utils.SVGBase.TextPath;
import com.limurse.svgloader.utils.SVGBase.TextSequence;
import com.limurse.svgloader.utils.SVGBase.Unit;
import com.limurse.svgloader.utils.SVGBase.Use;
import com.limurse.svgloader.utils.SVGBase.View;
import com.limurse.svgloader.utils.Style.CSSBlendMode;
import com.limurse.svgloader.utils.Style.FontStyle;
import com.limurse.svgloader.utils.Style.Isolation;
import com.limurse.svgloader.utils.Style.RenderQuality;
import com.limurse.svgloader.utils.Style.TextAnchor;
import com.limurse.svgloader.utils.Style.TextDecoration;
import com.limurse.svgloader.utils.Style.VectorEffect;
...
public class SVGAndroidRenderer
{
   ...
   */
   ...
   private Matrix calculateViewBoxTransform(Box viewPort, Box viewBox, PreserveAspectRatio positioning)
   {
      ...
      if (positioning == null || positioning.alignment == null)
         return m;
      ...
      float  scale = (positioning.scale == PreserveAspectRatio.Scale.slice) ? Math.max(xScale,  yScale) : Math.min(xScale,  yScale);
   ...
   private void renderMarker(Marker marker, MarkerVector pos)
   {
      ...
      if (marker.viewBox != null)
      {
         ...
         if (!positioning.equals(PreserveAspectRatio.STRETCH))
         {
            float  aspectScale = (positioning.scale == PreserveAspectRatio.Scale.slice) ? Math.max(xScale,  yScale) : Math.min(xScale,  yScale);
